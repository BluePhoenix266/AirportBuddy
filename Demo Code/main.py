...
if __name__ == '__main__':
    ...
    # dc_mot_bl = DcMotor(2, Pin.cpu.A0, Pin.cpu.C13, Pin.cpu.C14, encoder_bl)
    step_mot_bl = StepperMotor(Pin.cpu.C11, Pin.cpu.D2, Pin.cpu.A15)
    lim_switch_bl = LimitSwitch(Pin.cpu.A1)
    ...
    dc_mot_br = DcMotor(2, Pin.cpu.A0, Pin.cpu.C13, Pin.cpu.C14, encoder_bl)
    step_mot_br = StepperMotor(Pin.cpu.C15, Pin.cpu.H0, Pin.cpu.A15)
    lim_switch_br = LimitSwitch(Pin.cpu.A4)
    ...
    lim_switch_fl = LimitSwitch(Pin.cpu.C1)
    ...
    lim_switch_fr = LimitSwitch(Pin.cpu.C0)
    ...
    task1 = cotask.Task(TaskGearboxControl(dc_mot_bl_flg, step_mot_bl_flg,dc_mot_bl, step_mot_bl, lim_switch_bl).run,
                        "Task 1: Back Left Gearbox", priority=0, period=2)
    ...
    task3 = cotask.Task(TaskGearboxControl(dc_mot_fl_flg, step_mot_fl_flg, dc_mot_fl, step_mot_fl, lim_switch_fl).run,
                        "Task 3: Front Left Gearbox", priority=0, period=2)
